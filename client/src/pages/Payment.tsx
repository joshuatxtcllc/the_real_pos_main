...
const handlePaymentSuccess = useCallback(async (paymentIntentId: string) => {
    try {
      // Update payment link status and order group
      const response = await fetch(`/api/payment-links/${token}/complete`, {
        method: 'POST',
        headers: {
      ...
      toast({
        ...
        description: "Payment was processed but there was an issue updating the status. Please contact support.",
        variant: "destructive",
        duration: 10000,
      });
    }
