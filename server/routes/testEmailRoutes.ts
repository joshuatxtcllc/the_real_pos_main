...
router.post('/test-basic', async (req, res) => {
  ...
  try {
    // Try with a simple test email - this should match your verified sender in SendGrid
    const fromEmail = 'test@example.com'; // Change this to your verified sender email
