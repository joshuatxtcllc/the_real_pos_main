...
console.log(`🔥 FINAL NUCLEAR POS - NO STATIC FILES`);

app.use(express.json());

// FORCE SERVE ONLY THE POS HTML - NO STATIC FILE SERVING
app.get('*', (req, res) => {
  res.send(`<!DOCTYPE html>
<html><head><title>Jay's Frames POS - EMERGENCY SYSTEM</title>
<style>
...
<div class="container">
  <div class="header">
    <h1>🚨 Jay's Frames POS - EMERGENCY SYSTEM</h1>
  ...
  <div id="payment" class="section">
    ...
    <div class="form">
      <div class="form-group">
        ...
        <input type="text" id="paymentOrderId" placeholder="Enter order ID (e.g., ORD1704067200000)">
      </div>
      <div class="form-row">
        <div class="form-group">
...
function createOrder() {
  ...
  const laborCost = 35.00; // Base labor cost
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(\`✅ FINAL NUCLEAR POS RUNNING ON PORT \${PORT}\`);
